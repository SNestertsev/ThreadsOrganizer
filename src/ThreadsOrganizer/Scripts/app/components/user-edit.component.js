System.register(["@angular/core", "@angular/forms", "@angular/router", "../services/auth.service", "../model/user"], function (exports_1, context_1) {
    "use strict";
            ...
            UserEditComponent = (function () {
                ...
                UserEditComponent.prototype.onSubmit = function () {
                    ...
                    if (this.isRegister) {
                        ...
                        var user = new user_1.User(this.userForm.value.username, this.userForm.value.passwordCurrent, this.userForm.value.passwordNew, this.userForm.value.email, this.userForm.value.displayName);
